...
private:
  ...
  int aux;   ///< contador de reportes
  double    m_inicio; ///< inicio de reporte
...
MeshTest::MeshTest () :
  ...
  aux (0),//variable para ciclo for que permite imprimir un reporte cada segundo
  m_inicio(0.0),//indica al ciclo for en donde empezar
