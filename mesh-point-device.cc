...
MeshPointDevice::Report (std::ostream & os) const
{
  ...
  std::cerr <<" " << m_txStats.unicastDataBytes+m_txStats.broadcastDataBytes << " " << m_fwdStats.unicastDataBytes+m_fwdStats.broadcastDataBytes <<" " << m_rxStats.unicastDataBytes+m_rxStats.broadcastDataBytes <<"\n";
}
