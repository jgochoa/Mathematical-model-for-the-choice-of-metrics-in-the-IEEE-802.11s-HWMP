...
private:
  ...
  int      aux;
  int      MaxBytes; //Número total de bytes a enviar 
...
//Se envía flujos de datos de la manera más rápida posible
//en el protocolo de trasporte TCP.
//Crea un BulkSendApplication y lo instala en el nodo 0 
  uint16_t port = 9;  // well-known echo port number 
  BulkSendHelper source ("ns3::TcpSocketFactory", InetSocketAddress (interfaces.GetAddress (m_xSize*m_ySize-1), port)); 
...
// Crea un PacketSinkApplication y lo instala en el nodo 8
  PacketSinkHelper sink ("ns3::TcpSocketFactory", InetSocketAddress (Ipv4Address::GetAny (),  port)); 
  ApplicationContainer sinkApps = sink.Install (nodes.Get (m_xSize*m_ySize-1)); 
